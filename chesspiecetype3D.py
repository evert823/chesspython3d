    ...
    def VectorSetFromjson(self, mydict):
        ...
        for v in mydict:
            ...
            try:
                ...
                mymaxrange = 0
            myresult.append((myx, myy, myz, mymaxrange))
        return myresult
#---------------------------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------------------------
    def printcounts(self):
        s = (
            f"stepleapmovevectors: {len(self.stepleapmovevectors)}, "
            f"slidemovevectors: {len(self.slidemovevectors)}, "
            f"stepleapcapturevectors: {len(self.stepleapcapturevectors)}, "
            f"slidecapturevectors: {len(self.slidecapturevectors)}"
        )
        print(s)
#---------------------------------------------------------------------------------------------------------
